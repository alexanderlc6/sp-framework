package com.sp.framework.orm.lark.orm.dao.supports;

import java.util.List;
import java.util.Map;

import com.sp.framework.orm.lark.orm.dao.face.ConditionMapper;

public interface BaseDao<ET, PT> extends ConditionMapper<ET, PT>{
